...
from constants import NUMERICAL_COLS, CATEGORICAL_COLS, ORDINAL_COLS
...
df_encoded[all_numerical_to_scale] = scaler.fit_transform(
    df_encoded[all_numerical_to_scale]
)
